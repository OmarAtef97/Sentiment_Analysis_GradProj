...
x_train2 = scaler.fit_transform(x_train_cv)
x_test2 = scaler.transform(x_test_cv)
x_train3 = scaler.fit_transform(x_train_tv)
x_test3 = scaler.transform(x_test_tv)


# In[12]:


print('Train Accuracy = ', knn.score(x_train2, y_train)*100, '%')


# In[13]:


print('Test Accuracy = ', knn.score(x_test2, y_test)*100, '%')
...
matrix = classification_report(y_test, predict, labels=[0,1,2])
...
knn2.fit(x_train_tv, y_train)


# In[20]:


print('Train Accuracy = ', knn2.score(x_train2, y_train)*100, '%')


# In[21]:


print('Test Accuracy = ', knn2.score(x_test2, y_test)*100, '%')
...
for i, prediction in enumerate(predict2):
    if prediction == 1:
        pos_count += 1
    elif prediction == 0:
        neu_count += 1
...
matrix = classification_report(y_test, predict2, labels=[0,1,2])
print('Classification Report: \n', matrix)
...
predictions = knn2.predict(train_data_twitter)
predictions
